...
export reactflow_old

"""
    reactflow_old(;kwargs...)

A Reactflow_old component.
Reactflow is a Dash component for creating interactive node-based flows and diagrams.
It wraps the react-flow-renderer library.
Keyword arguments:
...
function reactflow_old(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("reactflow_old", "Reactflow_old", "dash_diagram", available_props, wild_props; kwargs...)
end
